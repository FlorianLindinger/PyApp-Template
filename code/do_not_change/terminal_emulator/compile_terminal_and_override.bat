...
REM ==================================
REM Replace "compiled" only after a
REM successful build and successful
REM prune step (if enabled)
REM ==================================
if /i "%DO_PRUNE%"=="yes" (
    set "FINAL_BUILD=!TARGET!"
) else (
    set "FINAL_BUILD=!SOURCE!"
)

if not exist "!FINAL_BUILD!\" (
    echo Final build folder not found: !FINAL_BUILD!
