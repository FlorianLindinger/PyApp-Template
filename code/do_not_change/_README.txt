...
py -3.12 -m pip install --target . --upgrade pywinpty 
py -3.12 -m pip install --target . --upgrade pywin32 
...
=================================
=== Pipreqs packages mappings ===
=================================

I updated the mapping of packages in python_packages\pipreqs\mapping to:
