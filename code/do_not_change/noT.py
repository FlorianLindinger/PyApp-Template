...
relative_path_to_actual_script = r"specific_scripts\start_program.py"
args = [sys.argv[1], "0"]  # [appid,create_terminal]
...
result = subprocess.run([python_exe, script_path, *args])  # noqa:S603
