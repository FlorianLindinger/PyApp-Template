...
fail_message: str = "[Error] Failed to run save_current_packages -versions: {e}"
...
try:
    ...
    from backend.DONT_CHANGE.settings.backend_settings import CURRENT_PACKAGES_WITH_VERSION_PATH
