...
from backend.DONT_CHANGE.scripts._common_variables import CURRENT_PACKAGES_NO_VERSION_PATH

try:
    ensure_python_distro()
    save_current_packages(CURRENT_PACKAGES_NO_VERSION_PATH, with_version=False)
    print()
